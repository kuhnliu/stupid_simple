...
MyQuicFramer::MyQuicFramer(const ParsedQuicVersionVector& supported_versions,
  ...
  use_incremental_ack_processing_=false;
}

MyQuicFramer::~MyQuicFramer() {}

// static
size_t MyQuicFramer::GetMinStreamFrameSize(QuicTransportVersion version,
...
// static
size_t MyQuicFramer::GetStopWaitingFrameSize(
    QuicTransportVersion version,
    QuicPacketNumberLength packet_number_length) {
...
// static
size_t MyQuicFramer::GetRstStreamFrameSize() {
  return kQuicFrameTypeSize + kQuicMaxStreamIdSize + kQuicMaxStreamOffsetSize +
         kQuicErrorCodeSize;
}

// static
size_t MyQuicFramer::GetMinConnectionCloseFrameSize() {
  return kQuicFrameTypeSize + kQuicErrorCodeSize + kQuicErrorDetailsLengthSize;
}

// static
size_t MyQuicFramer::GetMinGoAwayFrameSize() {
  return kQuicFrameTypeSize + kQuicErrorCodeSize + kQuicErrorDetailsLengthSize +
         kQuicMaxStreamIdSize;
}

// static
size_t MyQuicFramer::GetWindowUpdateFrameSize() {
  return kQuicFrameTypeSize + kQuicMaxStreamIdSize + kQuicMaxStreamOffsetSize;
}

// static
size_t MyQuicFramer::GetBlockedFrameSize() {
  return kQuicFrameTypeSize + kQuicMaxStreamIdSize;
}

// static
size_t MyQuicFramer::GetStreamIdSize(QuicStreamId stream_id) {
...
// static
size_t MyQuicFramer::GetStreamOffsetSize(QuicTransportVersion version,
                                       QuicStreamOffset offset) {
...
// static
size_t MyQuicFramer::GetVersionNegotiationPacketSize(size_t number_versions) {
...
bool MyQuicFramer::IsSupportedTransportVersion(
...
bool MyQuicFramer::IsSupportedVersion(const ParsedQuicVersion version) const {
...
size_t MyQuicFramer::GetSerializedFrameLength(
...
size_t MyQuicFramer::BuildDataPacket(const QuicPacketHeader& header,
...
size_t MyQuicFramer::BuildConnectivityProbingPacket(
...
// static
std::unique_ptr<QuicEncryptedPacket> MyQuicFramer::BuildPublicResetPacket(
...
// static
std::unique_ptr<QuicEncryptedPacket> MyQuicFramer::BuildIetfStatelessResetPacket(
...
// static
std::unique_ptr<QuicEncryptedPacket> MyQuicFramer::BuildVersionNegotiationPacket(
    QuicConnectionId connection_id,
    bool ietf_quic,
...
MyQuicFramer::BuildIetfVersionNegotiationPacket(
    QuicConnectionId connection_id,
    const ParsedQuicVersionVector& versions) {
...
bool MyQuicFramer::ProcessPacket(const QuicEncryptedPacket& packet) {
...
bool MyQuicFramer::ProcessVersionNegotiationPacket(
...
bool MyQuicFramer::ProcessDataPacket(QuicDataReader* encrypted_reader,
                                   QuicPacketHeader* header,
...
bool MyQuicFramer::ProcessPublicResetPacket(QuicDataReader* reader,
                                          const QuicPacketHeader& header) {
...
bool MyQuicFramer::AppendPacketHeader(const QuicPacketHeader& header,
...
const QuicTime::Delta MyQuicFramer::CalculateTimestampFromWire(
...
QuicPacketNumber MyQuicFramer::CalculatePacketNumberFromWire(
    QuicPacketNumberLength packet_number_length,
...
bool MyQuicFramer::ProcessPublicHeader(QuicDataReader* reader,
                                     QuicPacketHeader* header) {
...
bool MyQuicFramer::ProcessUnauthenticatedHeader(QuicDataReader* encrypted_reader,
                                              QuicPacketHeader* header) {
...
bool MyQuicFramer::ProcessAndCalculatePacketNumber(
    QuicDataReader* reader,
    QuicPacketNumberLength packet_number_length,
    QuicPacketNumber base_packet_number,
    QuicPacketNumber* packet_number) {
...
#include <stdio.h>
bool MyQuicFramer::ProcessFrameData(QuicDataReader* reader,
                                  const QuicPacketHeader& header) {
...
bool MyQuicFramer::ProcessStreamFrame(QuicDataReader* reader,
                                    uint8_t frame_type,
                                    QuicStreamFrame* frame) {
...
bool MyQuicFramer::ProcessIetfStreamFrame(QuicDataReader* reader,
                                        uint8_t frame_type,
                                        QuicStreamFrame* frame) {
...
bool MyQuicFramer::ProcessAckFrame(QuicDataReader* reader,
                                 uint8_t frame_type,
  ...
  if (!reader->ReadBytesToUInt64(largest_acked_length, &largest_acked)) {
    //printf("Unable to read largest acked.\n");
  ...
  if (!reader->ReadUFloat16(&ack_delay_time_us)) {
    //printf("Unable to read ack delay time.\n");
...
bool MyQuicFramer::ProcessTimestampsInAckFrame(uint8_t num_received_packets,
                                             QuicDataReader* reader,
                                             QuicAckFrame* ack_frame) {
...
bool MyQuicFramer::ProcessIetfAckFrame(QuicDataReader* reader,
                                     uint8_t frame_type,
                                     QuicAckFrame* ack_frame) {
  QuicPacketNumber largest_acked;
...
bool MyQuicFramer::ProcessStopWaitingFrame(QuicDataReader* reader,
                                         const QuicPacketHeader& header,
...
bool MyQuicFramer::ProcessRstStreamFrame(QuicDataReader* reader,
                                       QuicRstStreamFrame* frame) {
...
bool MyQuicFramer::ProcessConnectionCloseFrame(QuicDataReader* reader,
                                             QuicConnectionCloseFrame* frame) {
  uint32_t error_code;
  if (!reader->ReadUInt32(&error_code)) {
...
bool MyQuicFramer::ProcessGoAwayFrame(QuicDataReader* reader,
...
bool MyQuicFramer::ProcessWindowUpdateFrame(QuicDataReader* reader,
...
bool MyQuicFramer::ProcessBlockedFrame(QuicDataReader* reader,
...
void MyQuicFramer::ProcessPaddingFrame(QuicDataReader* reader,
                                     QuicPaddingFrame* frame) {
...
// static
QuicStringPiece MyQuicFramer::GetAssociatedDataFromEncryptedPacket(
    QuicTransportVersion version,
...
void MyQuicFramer::SetDecrypter(EncryptionLevel level,
...
void MyQuicFramer::SetAlternativeDecrypter(
...
const QuicDecrypter* MyQuicFramer::decrypter() const {
  return decrypter_.get();
}

const QuicDecrypter* MyQuicFramer::alternative_decrypter() const {
  return alternative_decrypter_.get();
}

void MyQuicFramer::SetEncrypter(EncryptionLevel level,
...
size_t MyQuicFramer::EncryptInPlace(EncryptionLevel level,
                                  QuicPacketNumber packet_number,
                                  size_t ad_len,
                                  size_t total_len,
                                  size_t buffer_len,
...
size_t MyQuicFramer::EncryptPayload(EncryptionLevel level,
                                  QuicPacketNumber packet_number,
...
size_t MyQuicFramer::GetMaxPlaintextSize(size_t ciphertext_size) {
...
bool MyQuicFramer::DecryptPayload(QuicDataReader* encrypted_reader,
                                const QuicPacketHeader& header,
                                const QuicEncryptedPacket& packet,
                                char* decrypted_buffer,
                                size_t buffer_length,
...
size_t MyQuicFramer::GetAckFrameSize(
...
size_t MyQuicFramer::ComputeFrameLength(
    const QuicFrame& frame,
    bool last_frame_in_packet,
    QuicPacketNumberLength packet_number_length) {
  switch (frame.type) {
...
bool MyQuicFramer::AppendTypeByte(const QuicFrame& frame,
...
// static
bool MyQuicFramer::AppendStreamId(size_t stream_id_length,
                                QuicStreamId stream_id,
                                QuicDataWriter* writer) {
...
// static
bool MyQuicFramer::AppendStreamOffset(size_t offset_length,
                                    QuicStreamOffset offset,
                                    QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendStreamFrame(const QuicStreamFrame& frame,
                                   bool no_stream_frame_length,
                                   QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendIetfStreamFrame(const QuicStreamFrame& frame,
                                       bool last_frame_in_packet,
                                       QuicDataWriter* writer) {
...
void MyQuicFramer::set_version(const ParsedQuicVersion version) {
...
bool MyQuicFramer::AppendStopWaitingFrame(const QuicPacketHeader& header,
...
bool MyQuicFramer::AppendIetfAckFrame(const QuicAckFrame& frame,
                                    QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendRstStreamFrame(const QuicRstStreamFrame& frame,
                                      QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendConnectionCloseFrame(
...
bool MyQuicFramer::AppendGoAwayFrame(const QuicGoAwayFrame& frame,
                                   QuicDataWriter* writer) {
  uint32_t error_code = static_cast<uint32_t>(frame.error_code);
  if (!writer->WriteUInt32(error_code)) {
    return false;
...
bool MyQuicFramer::AppendWindowUpdateFrame(const QuicWindowUpdateFrame& frame,
                                         QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendBlockedFrame(const QuicBlockedFrame& frame,
                                    QuicDataWriter* writer) {
  uint32_t stream_id = static_cast<uint32_t>(frame.stream_id);
  if (!writer->WriteUInt32(stream_id)) {
    return false;
...
bool MyQuicFramer::AppendPaddingFrame(const QuicPaddingFrame& frame,
                                    QuicDataWriter* writer) {
  if (version_.transport_version <= QUIC_VERSION_37) {
    writer->WritePadding();
    return true;
...
bool MyQuicFramer::RaiseError(QuicErrorCode error) {
...
Endianness MyQuicFramer::endianness() const {
  return version_.transport_version > QUIC_VERSION_38 ? NETWORK_BYTE_ORDER
                                                      : HOST_BYTE_ORDER;
}

bool MyQuicFramer::StartsWithChlo(QuicStreamId id,
...
QuicStringPiece MyQuicFramer::TruncateErrorString(QuicStringPiece error) {
...
bool MyQuicFramer::AppendIetfConnectionCloseFrame(
    const QuicConnectionCloseFrame& frame,
    QuicDataWriter* writer) {
...
bool MyQuicFramer::AppendIetfApplicationCloseFrame(
    const QuicConnectionCloseFrame& frame,
    QuicDataWriter* writer) {
...
//    phrase  (string)
bool MyQuicFramer::AppendIetfCloseFrame(const QuicIetfFrameType type,
                                      const uint16_t code,
...
//    phrase length (varint)
//    phrase  (string)
bool MyQuicFramer::ProcessIetfConnectionCloseFrame(
    QuicDataReader* reader,
...
bool MyQuicFramer::ProcessIetfApplicationCloseFrame(
    QuicDataReader* reader,
    const uint8_t frame_type,
    QuicConnectionCloseFrame* frame) {
  return ProcessIetfCloseFrame(reader, frame_type, frame);
...
bool MyQuicFramer::ProcessIetfCloseFrame(QuicDataReader* reader,
                                       const uint8_t frame_type,
                                       QuicConnectionCloseFrame* frame) {
  uint16_t code;
...
// encoding required.
bool MyQuicFramer::AppendIetfPaddingFrame(const QuicPaddingFrame& frame,
                                        QuicDataWriter* writer) {
...
// non-0x00 byte.
void MyQuicFramer::ProcessIetfPaddingFrame(QuicDataReader* reader,
                                         QuicPaddingFrame* frame) {
  DCHECK_GT(version_.transport_version, QUIC_VERSION_37);
  ProcessPaddingFrame(reader, frame);
}
...
bool MyQuicFramer::ProcessIetfPathChallengeFrame(QuicDataReader* reader,
...
bool MyQuicFramer::ProcessIetfPathResponseFrame(QuicDataReader* reader,
...
bool MyQuicFramer::AppendIetfPathChallengeFrame(
...
bool MyQuicFramer::AppendIetfPathResponseFrame(const QuicPathResponseFrame& frame,
                                             QuicDataWriter* writer) {
...
//    final offset
bool MyQuicFramer::AppendIetfResetStreamFrame(const QuicRstStreamFrame& frame,
                                            QuicDataWriter* writer) {
  // Put the type-byte in the header.
...
bool MyQuicFramer::ProcessIetfResetStreamFrame(QuicDataReader* reader,
                                             QuicRstStreamFrame* frame) {
...
bool MyQuicFramer::ProcessIetfStopSendingFrame(
    QuicDataReader* reader,
...
bool MyQuicFramer::AppendIetfStopSendingFrame(
...
bool MyQuicFramer::AppendIetfMaxDataFrame(const QuicWindowUpdateFrame& frame,
                                        QuicDataWriter* writer) {
...
bool MyQuicFramer::ProcessIetfMaxDataFrame(QuicDataReader* reader,
                                         QuicWindowUpdateFrame* frame) {
  frame->stream_id = 0;
  if (!reader->ReadVarInt62(&frame->byte_offset)) {
...
bool MyQuicFramer::AppendIetfMaxStreamDataFrame(
...
bool MyQuicFramer::ProcessIetfMaxStreamDataFrame(QuicDataReader* reader,
                                               QuicWindowUpdateFrame* frame) {
  if (!reader->ReadVarIntStreamId(&frame->stream_id)) {
...
bool MyQuicFramer::AppendIetfMaxStreamIdFrame(
...
bool MyQuicFramer::ProcessIetfMaxStreamIdFrame(QuicDataReader* reader,
...
bool MyQuicFramer::AppendIetfBlockedFrame(const QuicIetfBlockedFrame& frame,
                                        QuicDataWriter* writer) {
...
bool MyQuicFramer::ProcessIetfBlockedFrame(QuicDataReader* reader,
...
bool MyQuicFramer::AppendIetfStreamBlockedFrame(
    const QuicWindowUpdateFrame& frame,
    QuicDataWriter* writer) {
...
bool MyQuicFramer::ProcessIetfStreamBlockedFrame(QuicDataReader* reader,
                                               QuicWindowUpdateFrame* frame) {
  if (!reader->ReadVarIntStreamId(&frame->stream_id)) {
...
bool MyQuicFramer::AppendIetfStreamIdBlockedFrame(
...
bool MyQuicFramer::ProcessIetfStreamIdBlockedFrame(
    QuicDataReader* reader,
